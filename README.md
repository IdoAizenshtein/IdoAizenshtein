...
- **AI**: APIs (ChatGPT, Gemini generative-ai, Google Speech-to-Text), Machine Learning with scikit-learn Python, AI-assisted development using code generation tools such as Codex, Claude Code, and similar systems
...
- **DevOps & Security**: Experienced with containerization (Docker, Kubernetes), CI/CD (Jenkins) security best practices (OWASP), network technologies (VPN, TCP/UDP), version control (Git, SVN). OCR (Tesseract, Textract, Cloud Vision), Document Image Processing (Python, Obj-C, Java)
