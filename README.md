...
- **AI**: Machine Learning with scikit-learn Python, APIs (ChatGPT, Gemini generative-ai, Google Speech-to-Text), AI-assisted development using code generation tools such as Codex, Claude Code, and similar systems
